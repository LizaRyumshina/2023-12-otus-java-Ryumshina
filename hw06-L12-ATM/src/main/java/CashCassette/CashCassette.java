...
public class CashCassette implements BaseCashCassette {
    ...
    private final BaseBanknote banknoteType;
    private int currCountBanknote = 0;
    private int idATM;
    private boolean insideATM = false;
    private final int maxCountBanknotes;

    public CashCassette (BaseBanknote banknoteType, int maxBanknotes){
        this.id = globalID;
        globalID++;
        ...
        this.banknoteType = banknoteType.clone();
    ...
    public BaseBanknote getBanknoteType() {
        return banknoteType;
    }
